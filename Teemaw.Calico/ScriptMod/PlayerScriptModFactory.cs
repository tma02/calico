    ...
    public static IScriptMod Create(IModInterface mod, Config config)
    {
        return new TransformationRuleScriptModBuilder()
            ...
            .AddRule(new TransformationRuleBuilder()
                ...
                .When(config.PlayerOptimizationsEnabled)
                .ScopedTo(CreateFunctionDefinitionPattern("_process_animation"))
                .Matching(CreateGdSnippetPattern("node.set_animation(animation_data[\"emote\"])"))
                .Do(ReplaceAll)
                .With("calico_emote_anim.set_animation(animation_data[\"emote\"])"))
            .AddRule(new TransformationRuleBuilder()
                .Named("player_opt_process_animation_set_node_b")
                .When(config.PlayerOptimizationsEnabled)
                .ScopedTo(CreateFunctionDefinitionPattern("_process_animation"))
                .Matching(CreateGdSnippetPattern("node_b.set_animation(animation_data[\"emote\"])"))
                .Do(ReplaceAll)
                .With("calico_emote_anim_b.set_animation(animation_data[\"emote\"])"))
            .AddRule(new TransformationRuleBuilder()
